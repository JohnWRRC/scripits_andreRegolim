...
def create_EDGE_single(ListmapsED,escale_ed):
  grass.run_command('g.region',rast=ListmapsED)
  grass.run_command('r.neighbors',input=ListmapsED,output=ListmapsED+"_eroED_50m",method='minimum',size=5,overwrite = True)
  inputs=ListmapsED+"_eroED_50m"
